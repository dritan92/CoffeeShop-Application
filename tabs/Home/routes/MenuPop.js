...
export default class MenuPop extends Component {

  static propTypes = {
	isOpen: PropTypes.bool.isRequired,
    // Object object that has title, price,description, source, days and times
  ...
  getStyles = () => {
    return {
      ...
      objectInfo: this.state.expanded ? {
        flex: 0,
  ...
  render() {
    ...
    const { title, price,description, source, days, times } = pizza || {};
      ...
      <View style={styles.container}>
        ...
        >
          ...
          <View style={styles.content}>
            {/* Object poster, title and price and description */}
            <View
            ...
            >
              ...
              {/* Title and price and description */}
